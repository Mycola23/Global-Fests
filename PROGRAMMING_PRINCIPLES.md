...
- **Код:** [AccountController.cs:Register метод](https://github.com/Mycola23/Global-Fests/blob/234a158e02f63e7ad9646d42edad57431e6fdf74/Controllers/AccountController.cs#L29C9-L160C10)
...
*   **Приклад:** Алгоритм хешування паролів (генерація солі, використання SHA256/PBKDF2, комбінування солі та пароля) прихований всередині сервісу. Контролер реєстрації не знає, як саме захищається пароль, він лише передає "сирий" пароль і отримує хеш.
*   **Код:** Метод `HashPassword` у файлі [`Services/UserService.cs`](https://github.com/Mycola23/Global-Fests/blob/e6af8bac463b5152dfc9be4bbfb9fd4f86a3954e/Services/UserService.cs#L118C8-L132C10)
